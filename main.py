...
parser.add_argument("--image_dir", type=str, default="data/celeba-256-mini/images/")
parser.add_argument("--attr_path", type=str, default="data/celeba-256-mini/list.txt")
