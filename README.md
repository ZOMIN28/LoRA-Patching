...
Official PyTorch implementation of [**LoRA Patching: Exposing the Fragility of Proactive Defenses against Deepfakes**](https://xplorestaging.ieee.org/document/11298389).
...
### 3. Dataset
we provide a celebA-256-mini dataset, which contains 30,000 face images sampled from the celebA dataset and their attribute information. You can get it at [celebA-256-mini](https://drive.google.com/file/d/1v4KazZb9DFr_DpOFCwL-qGZc0AdYhBXq/view?usp=sharing), and put it at `LoRA-Patching/data/`.
...
**You can use the function `inject_lora()` to plug and play embed LoRA for your own GAN model.**
Running the following code to embed the LoRA patch into your model:
